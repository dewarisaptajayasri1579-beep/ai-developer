...
export const sessions: Session[] = [
  ...
  {
    slug: "github-deploy-vercel",
    number: 3,
    category: "Frontend",
    shortTitle: "GitHub & Deploy to Vercel",
    title: "GitHub & Deploy to Vercel",
    description: "Menyimpan source code dan mempublikasikan frontend ke internet.",
    steps: [
      { title: "Publish/push project ke GitHub" },
      { title: "Cek repository dan file source code" },
      { title: "Login Vercel" },
      { title: "Import repository GitHub" },
      { title: "Deploy" },
      { title: "Cek URL hasil deployment" },
      { title: "Uji tampilan mobile dan desktop" },
    ],
    practice: "Deploy frontend hasil sesi sebelumnya.",
    tools: [
      { name: "GitHub", url: "https://github.com" },
      { name: "Vercel", url: "https://vercel.com" },
    ],
    output: "Repository GitHub + URL frontend online",
    teacherNote: "Git cukup Repository, Commit, Push. Branch/merge belum perlu.",
  },
  {
